...
public class TracksAdapter extends RecyclerView.Adapter<TracksAdapter.ViewHolder> {
    ...
    public TracksAdapter(Context context, List<Track> tracks, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.tracks_item, parent, false);
